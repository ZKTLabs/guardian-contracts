...
contract ZKT is ERC20Upgradeable, ERC20BurnableUpgradeable, AccessControlUpgradeable {
    ...
    function setEsZKTAddress(address newEsZKTAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
